...
public class NhanVienViewModels {
    ...
    public NhanVienViewModels(String id, String ma, String ten, String tenDem, String ho, String gioiTinh, Date ngaySinh, String diaChi, String soDienThoai, String matKhau, String idCuaHang, String idChucVu, String idGuiBaoCao, int trangThai) {
        this.id = id;
        this.ma = ma;
        this.ten = ten;
        this.tenDem = tenDem;
