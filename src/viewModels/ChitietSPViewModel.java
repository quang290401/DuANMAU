...
public class ChitietSPViewModel {
    ...
    public ChitietSPViewModel(String id, String idSp, String idNsx, String idMS, String idDongSP, int namBH, String moTa, int soLgTon, BigDecimal giaNhap, BigDecimal giaBan) {
        this.id = id;
        this.idSp = idSp;
        this.idNsx = idNsx;
        this.idMS = idMS;
